...
namespace wcs.ViewModel
{
    public class ChangeStrategyDialogViewModel : ViewModelBase, IDialogResultable<MsgAction>
    {
        ...
        private DevWorkTypeE _outworktype;
        ...
        public DevWorkTypeE OUTWORKTYPE
        {
            get => _outworktype;
            set => Set(ref _outworktype, value);
        }
        ...
        internal void SetInStrategy(StrategyInE inStrategy)
        {
